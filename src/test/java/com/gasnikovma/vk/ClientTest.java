...
public class ClientTest {
    ...
    public void getUsers(){
        ...
        String wireMockResponse = """
                ...
                """;
            wireMockServer.stubFor(get(urlEqualTo("/users")).willReturn(
                    aResponse().withHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                            .withBody(wireMockResponse)));
        String userListResponse = jsonPlaceHolderClient.getUsers().block();
        assertEquals(userListResponse,2);
